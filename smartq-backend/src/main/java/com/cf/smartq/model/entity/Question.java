...
public class Question implements Serializable {
    ...
    @Pattern(regexp = "^\\{.*\\}$", message = "题目内容必须是有效的JSON格式")
     ...
     * 是否删除
     */
    @Min(value = 0, message = "是否删除标记必须是 0 或 1")
    @Max(value = 1, message = "是否删除标记必须是 0 或 1")
